...
export default function AboutUs() {
  return (
    ...
    <div className='block'>
    <div className='block-img'><img src='block1.jpg' width={150} height={300} ></img></div>
    <div className='block-img'><img src='block3.jpg' width={150} height={300}></img></div>
    <div className='block-img'><img src='block2.jpg' width={150} height={300}></img></div>
    <div className='block-img'><img src='block4.jpg' width={150} height={300}></img></div>
    </div>
